...
rawSailfishCounts <- rawSailfishCounts[!(rawSailfishCounts$CDS %in% rRNA), ]
str(rawSailfishCounts)
# 108118 obs. of  25 variables
...
write.table(rawSailfishCounts, "data/consolidated-Sailfish-results.rRNA-Filtered.txt",
